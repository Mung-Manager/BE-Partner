...
class Ticket(TimeStampedModel):
    id = models.AutoField(auto_created=True, primary_key=True, db_column="ticket_id", serialize=False, db_comment="티켓 아이디")
    ...
    ticket_type = models.CharField(max_length=32, db_comment="티켓 타입", choices=[(t.value, t.name) for t in TicketType])
