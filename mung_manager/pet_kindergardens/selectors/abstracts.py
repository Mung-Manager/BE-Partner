...
class AbstractPetKindergardenSelector(ABC):
    ...
    @abstractmethod
    def check_is_exists_pet_kindergarden_by_id_and_user(
        self, pet_kindergarten_id: int, user
    ) -> bool:
        pass
...
class AbstractRawPetKindergardenSelector(ABC):
    @abstractmethod
    def get_raw_pet_kindergarden_queryset_by_name(
        self, name: str
    ) -> QuerySet[RawPetKindergarden]:
        pass
