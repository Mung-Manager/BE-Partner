...
class TicketDeleteView(APIAuthMixin, APIView):
    ...
    def delete(
        self, request: Request, pet_kindergarden_id: int, ticket_id: int
    ) -> Response:
