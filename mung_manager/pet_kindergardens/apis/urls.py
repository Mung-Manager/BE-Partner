...
pet_kindergarden_urls = [
    path("", PetkindergardenListAPIManager.as_view(), name="pet-kindergarden-list"),
    path("/search", PetkindergardenSearchAPIManager.as_view(), name="pet-kindergarden-search"),
    path("/profile", PetkindergardenProfileAPIManager.as_view(), name="pet-kindergarden-profile"),
]

pet_kindergarden_ticket_urls = [
    path("/<int:pet_kindergarden_id>/tickets", TicketListAPIManager.as_view(), name="pet-kindergarden-tickets-list"),
    path(
...
pet_kindergarden_customer_urls = [
    path("/<int:pet_kindergarden_id>/customers", CustomerListAPIManager.as_view(), name="pet-kindergarden-customers-list"),
    path(
