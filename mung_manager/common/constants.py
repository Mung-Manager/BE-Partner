class SYSTEM_CODE:
    ...
    UNKNOWN_SERVER_ERROR = ("unknown_server_error", "An unknown server error occurred.")
    NOT_IMPLEMENTED = ("not_implemented", "This feature is not implemented yet.")
    ...
    NOT_FOUND_CUSTOMER_PET = ("not_found_customer_pet", "Customer pet does not exist.")
    ALREADY_EXISTS_CUSTOMER = ("already_exists_customer", "Customer already exists.")
