...
class User(AbstractBaseUser, TimeStampedModel, PermissionsMixin):
    id = models.AutoField(auto_created=True, primary_key=True, db_column="user_id", serialize=False, db_comment="유저 아이디")
...
class UserSocialProvider(SimpleModel):
    ...
    id = models.SmallAutoField(
        auto_created=True, primary_key=True, db_column="user_social_provider_id", serialize=False, db_comment="유저 소셜 제공자 아이디"
    )
